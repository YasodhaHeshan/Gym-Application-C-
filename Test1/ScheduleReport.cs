...
namespace Test1
{
    public partial class ScheduleReport : Form
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("select*from SelectSchedule where PlanName='"+cmb_sPlan.Text+"'", con);
            ...
            reportViewer1.LocalReport.ReportPath = @"C:\Users\DELL\Desktop\BackUp\7\Test1\Schedule_Plans.rdlc";
