...
namespace Test1
{
    public partial class FatLoss : Form
    {
        public FatLoss()
        {
            InitializeComponent();
        ...
        private void btn_select_Click(object sender, EventArgs e)
        {
            ...
            if (cmd_fatLoss.SelectedItem != null && !string.IsNullOrWhiteSpace(txt_uname.Text))
            {
                // Get the selected item from the ComboBox and the value from the TextBox
                string selectedItem = cmd_fatLoss.SelectedItem.ToString();
